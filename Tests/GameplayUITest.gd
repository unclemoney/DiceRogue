...
## GameplayUITest
##
## Test scene for verifying core gameplay UI integration.
...
func _ready() -> void:
	...
	print("[GameplayUITest] Core gameplay UI integrated.")
	print("[GameplayUITest] Verify: Tracker, Money, Dice Hand, Bottom Buttons")
