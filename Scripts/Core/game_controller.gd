...
@export var challenge_ui_path: NodePath         = ^"../GameUI/MarginContainer/MainVBox/MiddleSection/CenterColumn/ChallengeContainer/ContentVBox/ChallengeUI"
@export var challenge_container_path: NodePath  = ^"../GameUI/MarginContainer/MainVBox/MiddleSection/CenterColumn/ChallengeContainer"
...
func _on_game_start() -> void:
	...
	#grant_power_up("roll_efficiency")
	#grant_power_up("dice_diversity")
