...
func _find_dice_hand() -> void:
	...
	if not dice_hand:
		...
		if game_controller and game_controller.has_node("../GameUI/MarginContainer/MainVBox/MiddleSection/CenterColumn/DiceAreaContainer/DiceHand"):
			dice_hand = game_controller.get_node("../GameUI/MarginContainer/MainVBox/MiddleSection/CenterColumn/DiceAreaContainer/DiceHand")
	if not dice_hand:
