...
const COMPACT_SLOT_BORDER: Color = Color(0.713725, 0.301961, 0.478431, 0.0)
...
const COMPACT_OUTLINE: Color = Color(0.129412, 0.121569, 0.2, 0.0)
...
# KioskTile root stays 200x300, but the chrome bezel is drawn 12px outside
# each edge, giving a visual footprint of 224x324. Add extra spacing so
...
const FAN_ROW_SPACING: float = 15.0
...
func _calculate_fan_positions(count: int) -> Array[Vector2]:
	...
	var center_y: float = _fan_center.y + 50
