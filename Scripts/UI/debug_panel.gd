...
func _create_debug_tabs() -> void:
	...
	var tab_definitions = {
		...
		"Utilities": [
			...
			{"text": "Test Formatter", "method": "_debug_test_formatter"},
			{"text": "Notation: Metric", "method": "_debug_set_notation_metric"},
			{"text": "Notation: Scientific", "method": "_debug_set_notation_scientific"},
...
func _debug_grant_plus_a_dollar() -> void:
	if not game_controller:
		log_debug("No GameController found")
		return
...
## _debug_show_active_challenges() -> void:
...
func _debug_ui_find_missing() -> void:
	...
	var critical_paths = [
		...
		"MarginContainer/MainVBox/MiddleSection/CenterColumn/ChallengeContainer/ContentVBox/ChallengeUI",
		...
		"MarginContainer/MainVBox/MiddleSection/LeftColumn/ChoreMeterContainer/ContentVBox/GlowingTitle",
